...
public final class SensorProcessor {
    ...
    private static int evaluateScore(SensorReading reading) {
        ...
        if (thresholds == null) {
            System.out.println("No thresholds defined for sensor type: " + reading.getSensorType());
            return 0; // Default to score 0 if no thresholds are defined for the sensor type
        }
